...
{% cloudinary /assets/imgs/cityu.webp alt="Entrada a la Hong Kong CityU University" title="Entrada a la Hong Kong CityU University" %}
...
{% cloudinary /assets/imgs/hk.webp alt="Vista de Hong Kong (Pico Victoria)" title="Vista de Hong Kong (Pico Victoria)" %}
...
{% cloudinary /assets/imgs/thai.webp alt="Clubs de fiesta en Patong, mercado callejero en Old Town Phuket y león de guardia chino en el templo Put Cho" title="Clubs de fiesta en Patong, mercado callejero en Old Town Phuket y león de guardia chino en el templo Put Cho" %} 
...
{% cloudinary /assets/imgs/osaka.webp alt="Castillo de Osaka, mercado y lugares" title="Castillo de Osaka, mercado y lugares" %}
...
{% cloudinary /assets/imgs/tokyo.webp alt="Calles de Tokyo streets y estatua del último samurai (Saigo Takamori)" title="Calles de Tokyo streets y estatua del último samurai (Saigo Takamori)" %}
...
{% cloudinary /assets/imgs/korea.webp alt="Palacio Joseon Changgyeonggung y Bukchon Hanok Village" title="Palacio Joseon Changgyeonggung y Bukchon Hanok Village" %}
